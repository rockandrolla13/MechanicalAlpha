...
ALPHA_SPECS: tuple[FactorSpec, ...] = (
    ...
    FactorSpec("ETF_OPT_POSITIONING", "FI ETF Options Positioning", ("external_factors:etf_option_position",), notes="Requires point-in-time ETF options positioning rows with call/put, delta, ttm, notional, and publication time."),
